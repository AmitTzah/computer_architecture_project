...
\\intialize
add $r2, $imm, $zero, 16;
add $r13, $zero, $imm,16	\\devide the matrix into 4 blocks 
add $r14, $zero, $imm,8	
							\\devide the matrix into 4 blocks 
							\\ block end in 16-th 
								\\ and 8-th row,cluom respectivly
							\\and start in the 8th and  0th raw clom resp.
add $r3, $zero, $imm,8;			\\r=0
forloop1:
add $r4, $zero, $imm,0;		\\c=0    folloop1=4
forloop2:
